        ...
        try {
          ...
          if (player) {
            ...
            setMatchData({
              ...
              deaths: player.deaths > 7 ? `Yikes ${player.deaths} deaths` : 
                      player.deaths === 1 ? `Only ${player.deaths} death` : 
                      player.deaths === 0 ? `Goat 🐐 ${player.deaths} deaths` : 
              ...
              lane: player.lane,
              isOnLooseStreak: player.win ? "Logan is on a win streak 🔥" : "Logan is on a losing streak 😔"
            });
          }
        } 
        catch (error) {
      ...
      <>
        <div className="w-screen h-screen bg-gradient-to-r from-slate-900 to-slate-700">
          <div className="flex m-auto justify-center">
            ...
            <div className="w-fit flex flex-col text-center gap-y-4 text-white backdrop-blur-xs bg-sky-800/40 rounded-2xl p-8 border-2 border-white">
              <h1 className="text-6xl"> Match Check </h1>
              <div className="flex justify-center text-center">
                <h1 className="text-3xl"> Did Logan Lose his last game? </h1>
                <h2 className="text-4xl"> {matchData.lastMatch}</h2>
              </div>  
              <div className="flex justify-center text-center"> 
            ...
            <div className="w-fit flex flex-col text-center gap-y-4 text-white backdrop-blur-xs bg-rose-800/40 rounded-2xl p-8 border-2 border-white">
